...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7088dca4-7d73-47a6-8c85-ba9cf998884d
```

> `7088dca4-7d73-47a6-8c85-ba9cf998884d` is the password of the certificate, you can change it to any password you want.
